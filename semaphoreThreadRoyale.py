...
# Classe Personagem continua aqui...
    ...
    def atacar(self, outro_personagem: 'Personagem'):
        ...
        if aim >= self.accuracy:
            ...
            if aim <= 15:
                ...
                if arma_unica.tentar_pegar_arma() and not self.arma_unica:  # Verifica se o personagem já possui a arma única
                    self.arma_unica = True  # Marca que o personagem possui a arma única
